	...
	return (
		<div id="education" className="">
			...
			<div className="flex w-full justify-center mt-16">
				<div className="flex flex-col items-end flex-1 max-w-1/2">
					{/* <AnimatePresence>
						<motion.div
							...
							<div className="bg-[#101010] p-4 border-2 border-gray-600 hover:border-green-700 transistion duration-300 rounded-xl">
							<div className="flex">
					...
					<div className="h-[29rem] w-full bg-transparent mb-10"></div>
					{/* <AnimatePresence>
						<motion.div
							initial={{ x: -300, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
				...
				<div className="relative bg-green-500 rounded-full w-1 mx-8 flex flex-col items-center text-sm">
					...
					<div className="absolute top-[13.5%]  whitespace-nowrap bg-green-500 w-4 h-1 rounded-full flex items-center justify-center">
						<span className="-translate-x-1/2 px-4">
							Jan 2022 - Dec 2022
						</span>
					</div>
					...
					<div className="absolute top-[74.6%] whitespace-nowrap bg-green-500 w-4 h-1 rounded-full flex items-center justify-center">
						<span className="-translate-x-1/2 px-4">
							Jan 2021 - Jul 2021
						</span>
					</div>
					<div className="absolute top-[89.5%] whitespace-nowrap bg-green-500 w-4 h-1 rounded-full flex items-center justify-center">
						<span className="translate-x-1/2 px-4">Aug 2017 - May 2021</span>
					</div>
				</div>

				<div className="flex flex-col items-start flex-1 max-w-1/2">
					<div className="h-40 w-full bg-transparent mb-10"></div>
					{/* <AnimatePresence>
						<motion.div
							initial={{ x: 300, opacity: 0 }}
							whileInView={{ x: 0, opacity: 1 }}
