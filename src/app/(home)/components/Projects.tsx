...
export default function Projects() {
	...
	return (
        <div className="py-10 p-5 sm:p-0">
            <Title text="Projects 🎨" className="flex flex-col items-center justify-center text-center rotate-6"></Title>

            <div className="grid grid-cols-1 sm:grid-cols-2 pt-20 gap-5">
                {projects.map((project)=> {
                    return (
                        <Link href={project.link} key={project.title}>
                            <div className={cn("p-5 rounded-md",project.backgound)}>
                                <DirectionHover imageUrl={project.cover} className="w-full cursor-pointer">
